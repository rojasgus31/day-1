def extract_calibration_values(puzzle_input):
    total_sum = 0
    
    # split de los entries e iteracion en cada entry line
    for line in puzzle_input.strip().split('\n'):
        # Para extraer los numeros de cada entry
...
# Resultado
result = extract_calibration_values(puzzle_input)
